...
;
                ...
                var popup = '<div class="modal-body"></div> ';

                table += "<tr class = '${bg-color}' data-bs-toggle='modal' data-bs-target='#exampleModal'><th scope='row'><a style = 'color: black;' href = '" + getLinkIpfs(object.get("hash_ipfs")) + "' target = '_blank'>" + (i + 1) + "</a></th>";
